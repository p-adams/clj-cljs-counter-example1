...
var len__4531__auto___9944 = arguments.length;
var i__4532__auto___9945 = (0);
while(true){
if((i__4532__auto___9945 < len__4531__auto___9944)){
args__4534__auto__.push((arguments[i__4532__auto___9945]));

var G__9946 = (i__4532__auto___9945 + (1));
i__4532__auto___9945 = G__9946;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9941){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9942,G__9943,seq9941__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9947_SHARP_){
return !((cljs.core.meta.call(null,p1__9947_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__9948__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9952){var _e__8932__auto__ = e9952;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e9954){var _e__8932__auto__ = e9954;
return false;
}}
})())){
...
var _STAR_current_state_STAR_9956 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__9957 = opts;
...
var markup_db = cljs.core.get.call(null,map__9957__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_9956;
}});
...
;
var temp__5455__auto___9961 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___9961)){
var managed_print_level_9962 = temp__5455__auto___9961;
var _STAR_print_level_STAR_9960_9963 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_9962;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_9960_9963,managed_print_level_9962,temp__5455__auto___9961,writer,opts,job_fn){
return (function (p1__9959_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__9959_SHARP_,null);
});})(_STAR_print_level_STAR_9960_9963,managed_print_level_9962,temp__5455__auto___9961,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_9960_9963;
}} else {
job_fn.call(null);
}

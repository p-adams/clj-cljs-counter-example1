...
var G__9915 = devtools.prefs.pref.call(null,v);
v = G__9915;
continue;
} else {
return v;
...
}catch (e9918){var _e__8932__auto__ = e9918;
return false;
}})();
...
}catch (e9922){var _e__8932__auto__ = e9922;
return false;
}})();
...
}catch (e9924){var _e__8932__auto__ = e9924;
return false;
}}
}
});
...
var vec__9926 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__9926,(0),null);
...
return cljs.core.some.call(null,(function (p1__9929_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9929_SHARP_);
}),template);
});

...
var G__10145 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10145,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10145;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10147){
var G__10148 = cljs.core.first.call(null,seq10147);
var seq10147__$1 = cljs.core.next.call(null,seq10147);
var G__10149 = cljs.core.first.call(null,seq10147__$1);
var seq10147__$2 = cljs.core.next.call(null,seq10147__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10148,G__10149,seq10147__$2);
});
...
var file = cljs.core.get.call(null,map__10154__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10154__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10154__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10154,map__10154__$1,file,line,column){
return (function (p1__10153_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10153_SHARP_));
});})(map__10154,map__10154__$1,file,line,column))
...
var temp__5457__auto___10156 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10156)){
var message_10157 = temp__5457__auto___10156;
cljs.core.println.call(null,message_10157);
} else {
}
...
var temp__5457__auto___10158 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10158)){
var message_10159 = temp__5457__auto___10158;
cljs.core.println.call(null,message_10159);
} else {
}
...
var output_dir__$1 = (function (){var G__10160 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10160),"/"].join('');
} else {
return G__10160;
}
})();
...
var G__10162 = exception.stack;
var G__10162__$1 = (((G__10162 == null))?null:clojure.string.split_lines.call(null,G__10162));
var G__10162__$2 = (((G__10162__$1 == null))?null:cljs.core.get.call(null,G__10162__$1,depth));
if((G__10162__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10162__$2);
}
} else {
...
var vec__10163 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10163,(0),null);
var column = cljs.core.nth.call(null,vec__10163,(1),null);
var vec__10166 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10166,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10166,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10166,(2),null);
...
var m__$1 = (function (){var G__10169 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__10169__$1 = (((G__10169 instanceof cljs.core.Keyword))?G__10169.fqn:null);
switch (G__10169__$1) {
case "fail":
...
var G__10173 = (function (){var G__10172 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10172);
} else {
return G__10172;
}
})();
...
return cljs.core.vary_meta.call(null,G__10174,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__10178 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10178,(0),null);
var types = vec__10178;
...
return cljs.core.map.call(null,(function (p__10181){
var vec__10182 = p__10181;
var ns = cljs.core.nth.call(null,vec__10182,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10182,(1),null);
return ((function (vec__10182,ns,vars__$1){
return (function (){
...
var G__10185 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10185,G__10185__$1,env,once_fixtures,each_fixtures,vec__10182,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10185,G__10185__$1,env,once_fixtures,each_fixtures,vec__10182,ns,vars__$1){
return (function (){
var seq__10186 = cljs.core.seq.call(null,vars__$1);
var chunk__10187 = null;
var count__10188 = (0);
var i__10189 = (0);
while(true){
if((i__10189 < count__10188)){
var v = cljs.core._nth.call(null,chunk__10187,i__10189);
var temp__5457__auto___10191 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10191)){
var t_10192 = temp__5457__auto___10191;
each_fixture_fn.call(null,((function (seq__10186,chunk__10187,count__10188,i__10189,t_10192,temp__5457__auto___10191,v,each_fixture_fn,G__10185,G__10185__$1,env,once_fixtures,each_fixtures,vec__10182,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10192)));
});})(seq__10186,chunk__10187,count__10188,i__10189,t_10192,temp__5457__auto___10191,v,each_fixture_fn,G__10185,G__10185__$1,env,once_fixtures,each_fixtures,vec__10182,ns,vars__$1))
);
} else {
}


var G__10193 = seq__10186;
var G__10194 = chunk__10187;
var G__10195 = count__10188;
var G__10196 = (i__10189 + (1));
seq__10186 = G__10193;
chunk__10187 = G__10194;
count__10188 = G__10195;
i__10189 = G__10196;
continue;
} else {
...
var G__10197 = cljs.core.chunk_rest.call(null,seq__10186__$1);
var G__10198 = c__4351__auto__;
var G__10199 = cljs.core.count.call(null,c__4351__auto__);
var G__10200 = (0);
seq__10186 = G__10197;
chunk__10187 = G__10198;
count__10188 = G__10199;
i__10189 = G__10200;
continue;
} else {
var v = cljs.core.first.call(null,seq__10186__$1);
var temp__5457__auto___10201__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10201__$1)){
var t_10202 = temp__5457__auto___10201__$1;
each_fixture_fn.call(null,((function (seq__10186,chunk__10187,count__10188,i__10189,t_10202,temp__5457__auto___10201__$1,v,seq__10186__$1,temp__5457__auto__,each_fixture_fn,G__10185,G__10185__$1,env,once_fixtures,each_fixtures,vec__10182,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10202)));
});})(seq__10186,chunk__10187,count__10188,i__10189,t_10202,temp__5457__auto___10201__$1,v,seq__10186__$1,temp__5457__auto__,each_fixture_fn,G__10185,G__10185__$1,env,once_fixtures,each_fixtures,vec__10182,ns,vars__$1))
);
} else {
}


var G__10203 = cljs.core.next.call(null,seq__10186__$1);
var G__10204 = null;
var G__10205 = (0);
var G__10206 = (0);
seq__10186 = G__10203;
chunk__10187 = G__10204;
count__10188 = G__10205;
i__10189 = G__10206;
continue;
}
} else {
...
});})(each_fixture_fn,G__10185,G__10185__$1,env,once_fixtures,each_fixtures,vec__10182,ns,vars__$1))
);
});})(each_fixture_fn,G__10185,G__10185__$1,env,once_fixtures,each_fixtures,vec__10182,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10185__$1)].join('')));

}
})());
});
;})(vec__10182,ns,vars__$1))

...
var G__10462 = format;
var G__10462__$1 = (((G__10462 instanceof cljs.core.Keyword))?G__10462.fqn:null);
switch (G__10462__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__10464 = cljs.core.second(format);
var G__10465 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__10464,G__10465) : ajax.easy.keyword_response_format_element.call(null,G__10464,G__10465));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10468_SHARP_){
return ajax.easy.keyword_response_format_element(p1__10468_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__10469){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10470__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10470__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10470__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__10470,map__10470__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__10472){
var vec__10473 = p__10472;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10473,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10473,(1),null);
var fexpr__10476_10477 = (cljs.core.truth_(ok)?h:e);
(fexpr__10476_10477.cljs$core$IFn$_invoke$arity$1 ? fexpr__10476_10477.cljs$core$IFn$_invoke$arity$1(result) : fexpr__10476_10477.call(null,result));
...
;})(h,e,map__10470,map__10470__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__10478){
...
var opts = map__10479__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10479__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10479__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10479__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10479__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10479__$1,cljs.core.cst$kw$body);

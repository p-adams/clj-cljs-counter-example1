...
var G__11148 = o;
(G__11148[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__11150__i < G__11150__a.length) {G__11150__a[G__11150__i] = arguments[G__11150__i + 0]; ++G__11150__i;}
  args = new cljs.core.IndexedSeq(G__11150__a,0,null);
} 
...
var G__11152 = o;
(G__11152[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__11157 = props;
var G__11157__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11157,cljs.core.cst$kw$id,id):G__11157);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11157__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__11158){
...
var props = map__11159__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11159__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__11159,map__11159__$1,props,class$){
return (function (c){
...
});})(map__11159,map__11159__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__11161){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11162__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__11162,map__11162__$1,on_write){
return (function (){
...
});})(node_value,map__11162,map__11162__$1,on_write))
);
} else {
...
var G__11165 = jsprops;
(G__11165["defaultValue"] = value);

(G__11165["onChange"] = ((function (G__11165,v,value,on_change){
return (function (p1__11164_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__11164_SHARP_);
});})(G__11165,v,value,on_change))
);
...
var vec__11168 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11168,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11168,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11168,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___11172 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___11172 == null)){
} else {
var key_11173 = temp__5461__auto___11172;
(jsprops["key"] = key_11173);
}
...
var temp__5461__auto___11174 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___11174 == null)){
} else {
var key_11175 = temp__5461__auto___11174;
reagent.impl.template.oset(jsprops,"key",key_11175);
}
...
var G__11176 = reagent.impl.template.__GT_NativeWrapper();
(G__11176["name"] = c);
...
var G__11177 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__11177) : reagent.impl.template.as_element.call(null,G__11177));
} else {
...
var len__4531__auto___11182 = arguments.length;
var i__4532__auto___11183 = (0);
while(true){
if((i__4532__auto___11183 < len__4531__auto___11182)){
args__4534__auto__.push((arguments[i__4532__auto___11183]));

var G__11184 = (i__4532__auto___11183 + (1));
i__4532__auto___11183 = G__11184;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq11180){
var G__11181 = cljs.core.first(seq11180);
var seq11180__$1 = cljs.core.next(seq11180);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11181,seq11180__$1);
});
...
var n__4408__auto___11189 = a.length;
var i_11190 = (0);
while(true){
if((i_11190 < n__4408__auto___11189)){
(a[i_11190] = reagent.impl.template.as_element((a[i_11190])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___11192 = a.length;
var i_11193 = (0);
while(true){
if((i_11193 < n__4408__auto___11192)){
var val_11194 = (a[i_11193]);
if(((cljs.core.vector_QMARK_(val_11194)) && ((reagent.impl.template.key_from_vec(val_11194) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_11193] = reagent.impl.template.as_element(val_11194));
...
var ctx = ({});
var vec__11196 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11196,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11196,(1),null);
...
var G__11199 = (cljs.core.count(argv) - first_child);
switch (G__11199) {
case (0):
...
case (1):
var G__11200 = comp;
var G__11201 = jsprops;
var G__11202 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__11200,G__11201,G__11202) : reagent.impl.template.global$module$react.createElement.call(null,G__11200,G__11201,G__11202));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__11199){

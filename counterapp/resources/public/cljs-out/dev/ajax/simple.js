...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__10426){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10427__$1,cljs.core.cst$kw$handler);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__3949__auto__ = p1__10429_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__10430){
var map__10431 = p__10430;
var map__10431__$1 = ((((!((map__10431 == null)))?(((((map__10431.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10431.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10431):map__10431);
var request = map__10431__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10431__$1,cljs.core.cst$kw$interceptors);

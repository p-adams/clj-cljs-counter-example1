...
if((i < len)){
var k = (ks[i]);
var G__11040 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__11041 = (i + (1));
m = G__11040;
i = G__11041;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__11042 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__11042) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__11042));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__11044 = c;
var G__11044__$1 = (((G__11044 == null))?null:G__11044.prototype);
if((G__11044__$1 == null)){
return null;
} else {
return (G__11044__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__11046 = c;
var G__11046__$1 = (((G__11046 == null))?null:G__11046.prototype);
if((G__11046__$1 == null)){
return null;
} else {
return (G__11046__$1["render"]);
}
})() == null))));
});
...
var G__11048 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__11048) : reagent.impl.component.as_element.call(null,G__11048));
};
...
while (G__11051__i < G__11051__a.length) {G__11051__a[G__11051__i] = arguments[G__11051__i + 0]; ++G__11051__i;}
  args = new cljs.core.IndexedSeq(G__11051__a,0,null);
} 
...
var _STAR_current_component_STAR_11054 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_11054;
}});
...
return ((function (G__11055,G__11055__$1){
...
var c = this;
var G__11060_11062 = (c["cljsRatom"]);
if((G__11060_11062 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11060_11062);
}
...
var renders_11064 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_11065 = cljs.core.first(cljs.core.vals(renders_11064));
if((cljs.core.count(renders_11064) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11064))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11065)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11065], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__11063 = name;
switch (G__11063) {
case "":
...
var G__11068 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__11068) : reagent.impl.component.global$module$create_react_class.call(null,G__11068));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__11069 = fiber;
var G__11069__$1 = (((G__11069 == null))?null:(G__11069["type"]));
if((G__11069__$1 == null)){
return null;
} else {
return (G__11069__$1["displayName"]);
}
})();
var parent = (function (){var G__11070 = fiber;
if((G__11070 == null)){
return null;
} else {
return (G__11070["return"]);
}
})();
var path = (function (){var G__11071 = parent;
var G__11071__$1 = (((G__11071 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__11071) : reagent.impl.component.fiber_component_path.call(null,G__11071)));
if((G__11071__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11071__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__11073 = c;
if((G__11073 == null)){
return null;
} else {
return (G__11073["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__11074._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__11076 = c;
if((G__11076 == null)){
return null;
} else {
return (G__11076["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__11078 = c;
if((G__11078 == null)){
return null;
} else {
return G__11078._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__11080 = instance;
if((G__11080 == null)){
return null;
} else {
return (G__11080["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__11081 = instance;
if((G__11081 == null)){
return null;
} else {
return G__11081._currentElement;
}
}
})();
var name = (function (){var G__11082 = elem;
var G__11082__$1 = (((G__11082 == null))?null:(G__11082["type"]));
if((G__11082__$1 == null)){
return null;
} else {
return (G__11082__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__11084 = elem;
if((G__11084 == null)){
return null;
} else {
return (G__11084["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__11085._owner;
}
}
})();
var path = (function (){var G__11086 = owner;
var G__11086__$1 = (((G__11086 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__11086) : reagent.impl.component.component_path.call(null,G__11086)));
if((G__11086__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11086__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__11087 = c;
var G__11087__$1 = (((G__11087 == null))?null:G__11087.constructor);
if((G__11087__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__11087__$1);
}
}
})();
